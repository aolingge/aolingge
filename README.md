...
<p align="center">
  ...
  <a href="https://blog.aolingge.dev"><img src="https://img.shields.io/badge/Blog-aolingge.dev-0ea5e9?style=for-the-badge&logo=wordpress" alt="Blog" /></a>
...
`Python` · `Java` · `Vue` · `TypeScript` · `Spring Boot` · `Docker`

<br />

**Links**

[GitHub](https://github.com/aolingge) · [Blog](https://blog.aolingge.dev) · [Email](mailto:1930668092@qq.com)
...
- Computer Science student focused on practical engineering and project delivery.
- I build local-first tools that reduce repetitive work.
- I like turning scattered scripts into reusable workflows.
- I care about clean delivery, clear structure, and stable handoff.
- Current direction: Germany master's application, APS preparation, German learning, and shipping useful projects.
...
- Documenting reusable workflows on my blog
...
- README quality, deployment notes, logging, backup, and iteration

#### Contact

- Email: 1930668092@qq.com
- GitHub: [@aolingge](https://github.com/aolingge)
- Blog: [blog.aolingge.dev](https://blog.aolingge.dev)
